...
namespace Lighter.NET.UiComponents
{
    ...
    /// </summary>
    public class Date:UiElementBase
    {
        public override UiElementType ElementType => UiElementType.Date;
        ...
        /// </summary>
        [SettingProperty]
        public string DATETIME_FORMAT { get; set; } = "yyyy-MM-dd";
        /// <summary>
        ...
        public override string Render(IUiElement? setting = null)
        {
            ...
            string html = $"<input type=\"date\" {NameAttribute} {IDAttribute} {valueAttr} {minAttr} {maxAttr} class=\"{CssClass}\" {RequiredDataAttribute()} {TemplateDataAttribute()} {DisabledAttribute}>";
            return html;
        }
